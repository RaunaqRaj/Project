  ...
  <header class="text-gray-600 body-font">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
      ...
      <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
        ...
        <a class="mr-5 hover:text-gray-900" href="sports.html">Services</a>
      ...
      <section class="text-gray-600 body-font relative">
        <div class="container px-5 py-24 mx-auto">
          <div class="flex flex-col text-center w-full mb-12">
            ...
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Any type of query? ask here !! we are always here to help.</p>
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Thank you for submitting your form.</p>
          </div>
          <div class="lg:w-1/2 md:w-2/3 mx-auto">
            <div class="flex flex-wrap -m-2">
              ...
              <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                <a class="text-indigo-500">flyhigh265@gmail.com</a>
                <p class="leading-normal my-5">1554/28, Hari Singh Nalwa Str
                  <br>Delhi
                </p>
